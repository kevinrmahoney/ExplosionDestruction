...
/* All INIs defined below! Make sure to create a declaration in the header file (Environment.h)! */
...
// Cheats
DEFINE_CVAR(int32,      InfiniteHealth,          0,         ECVF_Cheat,       "Become invincible to all damage")
DEFINE_CVAR(int32,      PauseFire,               0,         ECVF_Cheat,       "Pause fire movement")
...
DEFINE_CVAR(int32,      DebugHits,               0,         ECVF_Cheat,       "Debug weapon damage dealt, hit actors, etc")
DEFINE_CVAR(int32,      DebugFire,               0,         ECVF_Cheat,       "Debug the fire - its movement, things it hits, etc")